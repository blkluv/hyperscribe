...
const costBreakdown = [
  {
    ...
    notes:
      "CREAI.DIGITAL's fixed monthly cost includes all services and deliverables with no hidden fees",
  },
  {
    ...
    notes:
      "CREAI.DIGITAL delivers more content at a lower cost due to our AI-powered workflow",
  },
  {
    ...
    notes:
      'Start with CREAI.DIGITAL immediately with no setup fees or long-term commitments',
  },
  {
    ...
    notes:
      "All premium tools and software included in CREAI.DIGITAL's monthly rate",
  },
];
            ...
            <Table>
              <TableHeader>
                <TableRow className="bg-slate-50">
                  ...
                  <TableHead className="text-center bg-blue-50 text-blue-700">
                    CREAI.DIGITAL
                  </TableHead>

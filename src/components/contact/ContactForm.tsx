...
const ContactForm = () => {
  ...
  return <motion.div initial={{
    ...
    duration: 0.7
  }} className="bg-white shadow-lg p-8 border border-gray-100 h-full flex flex-col px-[31px] py-[32px] mx-0 my-0 rounded-xl">
      ...
      <Form {...form}>
        <form onSubmit={form.handleSubmit(onSubmit)} className="space-y-6 flex-grow flex flex-col">
          ...
          field
                ...
                <FormControl>
                  <Input placeholder="Your name" className="rounded-lg focus:ring-blue-500" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
          ...
          field
                ...
                <FormControl>
                  <Input placeholder="email@example.com" className="rounded-lg focus:ring-blue-500" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
          ...
          field
                ...
                <FormControl>
                  <Textarea placeholder="How can we help you?" className="rounded-lg min-h-32 focus:ring-blue-500" {...field} />
                </FormControl>
                <FormMessage />
              </FormItem>} />
          
          <Button type="submit" disabled={isSubmitting} className="w-full rounded-full py-6 bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 transition-all duration-300 mt-auto">

  ...
  return (
    ...
    >
      ...
      <motion.p 
        ...
        className="text-lg md:text-xl text-muted-foreground mb-6 max-w-xl lg:mx-0 mx-auto"
      >
      ...
      >
        <a href="https://calendly.com/hyperscriber/free-introductory-call" target="_blank" rel="noopener noreferrer">
          <Button className="rounded-full px-8 py-6 shadow-lg hover:shadow-xl transition-all text-base bg-gradient-to-r from-blue-600 to-blue-700 hover:from-blue-700 hover:to-blue-800 relative overflow-hidden group">
